...
import UserInterface.Tier1Role.*;
 ...
 * @author Jyoti
 */
public class Tier2ProcessArea extends javax.swing.JPanel {
    ...
    private Tier2WorkRequest request;
    private UserAccount account;
    //private Location enterprise;
    public Tier2ProcessArea(JPanel userProcessContainer, UserAccount account,  Tier2WorkRequest request) {
        initComponents();
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        Tier2WorkAreaJPanel t2wjp = (Tier2WorkAreaJPanel) component;
        t2wjp.populateTable();
